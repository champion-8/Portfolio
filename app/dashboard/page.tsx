...
export default function DashboardPage() {
  ...
  const [sortField, setSortField] = useState<keyof PortfolioItem | "none">(
    "none",
  );
  ...
  const t = {
    ...
    distributionByType:
      language === "th" ? "แบ่งตามประเภท" : "Distribution by type",
              ...
              <div className="mb-4">
                <h2 className="text-base font-semibold text-gray-900 flex items-center gap-2">
                  <div className="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center">
                    <Icon
                      icon="hugeicons:chart-no-axes-combined"
          ...
          <>
                    ...
                    <tr>
                      ...
                      <th className="px-6 py-4 text-sm text-center font-bold text-gray-900">
                        <button
                          ...
                          className="flex items-center gap-1.5 justify-center w-full hover:text-purple-600 transition-colors cursor-pointer"
                        >
                          Type
                          {sortField === "assetType" && (
                            <Icon
                      ...
                      <th className="px-6 py-4 text-sm text-right font-bold text-gray-900">
                        <button
                          ...
                          className="flex items-center gap-1.5 justify-end w-full hover:text-purple-600 transition-colors cursor-pointer"
                        >
                          Quantity
                          {sortField === "quantity" && (
                            <Icon
                    ...
                    {sortedPortfolio.map((item) => (
                      ...
                      >
                        <td className="px-6 py-3">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0 flex-1">
                              <div
                                className="text-xs font-semibold text-gray-900 truncate max-w-[200px]"
                              ...
                              <div className="text-xs font-medium text-gray-600">
                                {item.assetType === "fund" &&
                                item.assetDetails &&
                                "projAbbrName" in item.assetDetails &&
                                item.assetDetails.projAbbrName
                        ...
                        <td className="px-6 py-3 text-xs text-right font-medium text-gray-500">
                          ฿
                          {item.avgBuyPrice.toLocaleString(undefined, {
                        ...
                        <td className="px-6 py-3 text-right">
                          ...
                          <div
                            className={`text-xs font-medium ${item.profitPercent >= 0 ? "text-green-500" : "text-red-500"}`}
                          >
                            <Icon
                              icon={
            ...
            <div className="lg:hidden space-y-4">
              ...
              {["fund", "stock", "crypto"].map((type) => {
                const items = sortedPortfolio.filter(
                  (item) => item.assetType === type,
                );
                  ...
                  <div key={type} className="card-1 overflow-hidden">
                    ...
                    >
                      ...
                      <div className={`flex rounded-lg overflow-hidden`}>
                            ...
                            mobileDisplayMode === "baht"
                              ? type === "fund"
                                ...
                                : type === "stock"
                                  ...
                                  : "text-blue-700"
                              : type === "fund"
                                ? "text-grey-500 hover:bg-purple-100"
                                : type === "stock"
                                  ? "text-grey-500 hover:bg-pink-100"
                        ...
                        <div
                          className={`w-px h-6 bg-gray-400 self-center`}
                        ></div>
                        <button
                    ...
                    <div className="px-3 py-2 bg-gray-50 border-b border-gray-200 flex items-center text-xs font-semibold text-gray-600">
                      <div className="flex-1">
                        {language === "th" ? "สัญลักษณ์" : "Symbol"}
                      </div>
                      <div className="flex-2 text-right pr-1">
                        {language === "th" ? "มูลค่า / กำไร-ขาดทุน" : "Value"}
                      </div>
                    </div>
                    ...
                    <div className="divide-y divide-gray-200">
                      {items.map((item) => {
                        const itemPercentage =
                          (item.currentValue / groupTotal) * 100;
                          ...
                          >
                            <div className="flex items-center text-xs gap-2">
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="font-medium text-gray-900 text-sm line-clamp-2 leading-tight overflow-hidden break-all">
                                  ...
                                  item.assetDetails.projAbbrName
                                    ? String(item.assetDetails.projAbbrName)
                                    : item.assetDetails &&
                                        "baseSymbol" in item.assetDetails &&
                                        item.assetDetails.baseSymbol
                              ...
                              <div className="flex-2 text-right space-y-0.5 min-w-0">
                                ...
                                {/* Line 2: P/L */}
                                <div
                                  className={`font-medium text-xs flex items-center justify-end gap-1 ${
                                    item.profit >= 0
                                      ? "text-green-600"
                                      : "text-red-600"
                                  }`}
                            ...
                            <div className="items-center mt-3">
                              ...
                              <div className="text-xs font-bold text-gray-500 mb-1 flex items-center gap-1">
                                ...
                                <Icon
                                  ...
                                  className={`w-3.5 h-3.5 ${totalProfit >= 0 ? "text-green-700" : "text-red-700"}`}
                                />
                              </div>
                              <div className="flex items-center gap-2">
                                <span
                ...
                <div className="flex items-center gap-3">
                  <div
                    className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                      selectedItem.assetType === "fund"
                        ? "bg-purple-100 border border-purple-200"
                        : selectedItem.assetType === "stock"
                          ? "bg-pink-100 border border-pink-200"
                          : "bg-blue-100 border border-blue-200"
                    }`}
                  >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      ...
                      "projAbbrName" in selectedItem.assetDetails &&
                      selectedItem.assetDetails.projAbbrName
                        ? String(selectedItem.assetDetails.projAbbrName)
                        : selectedItem.assetDetails &&
                            "baseSymbol" in selectedItem.assetDetails &&
                            selectedItem.assetDetails.baseSymbol
